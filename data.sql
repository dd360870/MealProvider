# restaurant
INSERT INTO `restaurant` (`id`, `name`, `description`, `tag`, `is_available`) VALUES
    (1, "傳統豆花店", NULL, "甜點", 1),
    (2, "燒臘便當店", NULL, "中式", 1),
    (3, "牛肉麵店", NULL, "中式", 1),
    (4, "炒飯店", NULL, "中式", 1),
...
INSERT INTO `meal` (`id`, `name`, `description`, `price`, `restaurant_id`, `is_available`) VALUES
    (1, "原味豆花", "簡單清爽的豆花口味，以豆漿製成。", 50, 1, 1),
    (2, "紅豆豆花", "加入了甜軟煮熟的紅豆，增添了甜味和口感。", 55, 1, 1),
    (3, "花生豆花", "混入了研磨成花生醬的花生，帶來香濃的花生風味。", 60, 1, 1),
    (4, "黑糖豆花", "加入了黑糖糖漿，給豆花帶來了濃郁的甜味和深厚的色澤。", 65, 1, 1),
    (5, "珍珠豆花", "類似於珍珠奶茶中的珍珠，但是加在豆花上，增添了咬勁和口感。", 70, 1, 1),
    (6, "叉燒便當", "以豬肉為主，用特製的醬汁調味，烤得香脆多汁。", 60, 2, 1),
    (7, "燒肉便當", "以豬肉為主，經過特殊的調味和烹飪方式，肉質鮮嫩多汁。", 65, 2, 1),
    (8, "燒鴨便當", "傳統的烤鴨肉，燒烤至外酥內嫩，風味獨特。", 70, 2, 1),
    (9, "雞腿便當", "嫩滑多汁的雞腿肉，經過燒烤或烤箱烤製，風味鮮美。", 75, 2, 1),
    (10, "燒鵝便當", "特色的烤鵝肉，肉質鮮嫩，滋味濃郁。", 80, 2, 1),
    (11, "燒魚便當", "用特殊的調味烤製魚肉，燒得香嫩可口。", 70, 2, 1),
    (12, "燒豬腳便當", "以豬腳為主，經過長時間燉煮後再燒製，肉質軟嫩入味。", 65, 2, 1),
    (13, "燒鴨腿便當", "以鴨腿為主，烤製至外酥內嫩，肉質鮮美。", 70, 2, 1),
    (14, "燒魚頭便當", "以魚頭為主，經過特殊的調味和烹飪方式，肉質鮮嫩可口。", 75, 2, 1),
    (15, "燒雞翅便當", "嫩滑多汁的雞翅肉，烤製至外酥內嫩，美味可口。", 80, 2, 1),
    (16, "紅燒牛肉麵", "特色的紅燒牛肉麵，肉質鮮嫩多汁，湯頭香濃。", 170, 3, 1),
    (17, "清燉牛肉麵", "清淡口味的清燉牛肉麵，湯頭清爽鮮美。", 150, 3, 1),
    (18, "蔬菜炒飯", "新鮮的蔬菜和米飯炒製而成，清淡可口。", 60, 4, 1),
    (19, "雞肉炒飯", "鮮嫩的雞肉和米飯經過炒製，風味獨特。", 85, 4, 1),
    (20, "牛肉炒飯", "嫩滑的牛肉與米飯經過炒製，口感豐富。", 90, 4, 1),
    (21, "蝦仁炒飯", "鮮嫩多汁的蝦仁與米飯炒製而成，鮮香可口。", 100, 4, 1),
    (22, "經典牛肉漢堡", "嫩滑多汁的牛肉餅，配以新鮮生菜、番茄和自製醬料。", 80, 5, 1),
    (23, "起司漢堡", "經典牛肉漢堡加上濃郁的起司片，帶來雙重享受。", 90, 5, 1),
    (24, "培根漢堡", "加入脆香培根的牛肉漢堡，風味更上一層樓。", 95, 5, 1),
    (25, "雞肉漢堡", "以嫩滑雞胸肉製成的漢堡，配以清爽的生菜和美味的醬料。", 85, 5, 1),
    (26, "素食漢堡", "以植物製成的素肉餅，滿足素食愛好者的需求。", 75, 5, 1),
    (27, "經典番茄肉醬麵", "傳統的義大利番茄肉醬，配上新鮮的義大利麵條。", 150, 6, 1),
    (28, "奶油培根麵", "濃郁的奶油醬汁搭配脆香的培根和義大利麵條。", 160, 6, 1),
    (29, "青醬海鮮麵", "以新鮮的海鮮和香濃的青醬調製而成，味道鮮美。", 180, 6, 1),
    (30, "茄汁海鮮麵", "用鮮美的茄汁和各種海鮮混合而成，風味十足。", 170, 6, 1),
    (31, "香蒜橄欖油麵", "簡單而美味的義大利麵，配以香蒜和橄欖油。", 140, 6, 1),
    (32, "壽司拼盤", "各種新鮮的壽司組合，包括鮪魚、鮭魚、玉子燒等。", 150, 7, 1),
    (33, "鰻魚飯", "烤鰻魚配以香甜的醬汁，搭配軟糯的米飯。", 200, 7, 1),
    (34, "天婦羅定食", "各種炸物如蝦天婦羅、蔬菜天婦羅，配以米飯和味噌湯。", 180, 7, 1),
    (35, "拉麵", "豐富的湯頭搭配豬肉片、煮蛋、海苔等多種配料。", 120, 7, 1),
    (36, "珍珠奶茶", "經典的台灣飲料，香濃的奶茶配上Q彈的珍珠。", 50, 8, 1),
    (37, "百香果綠茶", "清爽的綠茶搭配百香果香氣，酸甜可口。", 45, 8, 1),
    (38, "芒果冰沙", "新鮮芒果製成的冰沙，口感濃郁，清涼解暑。", 60, 8, 1),
    (39, "蜂蜜檸檬水", "清爽的檸檬水加入天然蜂蜜，健康又解渴。", 40, 8, 1),
    (40, "草莓奶昔", "香甜的草莓和濃郁的奶製成的奶昔，口感滑順。", 55, 8, 1),
    (41, "巧克力熔岩蛋糕", "外脆內軟的巧克力蛋糕，切開後流出濃郁的巧克力漿。", 80, 9, 1),
    (42, "草莓奶油蛋糕", "新鮮草莓和輕盈奶油夾心的蛋糕，甜而不膩。", 75, 9, 1),
    (43, "檸檬塔", "酸甜爽口的檸檬塔，搭配酥脆的塔皮。", 70, 9, 1),
    (44, "抹茶卷", "濃郁的抹茶風味蛋糕卷，內含香滑奶油。", 85, 9, 1),
    (45, "焦糖布丁", "滑順的布丁配上香甜的焦糖醬，口感絕佳。", 60, 9, 1);
